...
-- NOTA: Ejecutar estas líneas solo si la base de datos no existe
...
CREATE TABLE propiedades (
    ...
    -- Información Básica (Formulario publicar-propiedad.html)
    ...
    -- Ubicación (Formulario publicar-propiedad.html)
    calle VARCHAR(150),
    altura VARCHAR(20),
    piso VARCHAR(10),
    departamento VARCHAR(10), -- 'unidad' en el schema anterior
    barrio VARCHAR(100),
    ciudad VARCHAR(100),
    codigo_postal VARCHAR(20),
    latitud DECIMAL(10, 8), -- Para mostrar en mapa exacto si se desea
    longitud DECIMAL(11, 8), -- Para mostrar en mapa exacto si se desea
    direccion_visible BOOLEAN DEFAULT TRUE, -- Checkbox "Mostrar dirección exacta"
    
    -- Características Físicas (Formulario publicar-propiedad.html)
...
-- Nota: En producción usar hashes reales generados por bcrypt/argon2
INSERT INTO usuarios (email, password_hash, nombre_completo, rol) 
VALUES ('admin@lacasona.com', '$2y$10$exampleHashForAdmin123', 'Administrador Sistema', 'admin');

-- Usuario Cliente de Prueba (Maria Vargas)
INSERT INTO usuarios (email, password_hash, nombre_completo, rol) 
VALUES ('mariayvargas@hotmail.com', '$2y$10$exampleHashForMaria123', 'Maria Vargas', 'cliente');
...
VALUES (1, 'Hermosa Casa en Palermo Soho', 'Casa reciclada a nuevo con patio y parrilla. Excelente ubicación.', 'venta', 'casa', 'USD', 350000.00, 'Gurruchaga', '1500', 'Palermo', 'CABA', 4, 3, 2, 180.00, TRUE);

-- Propiedad de Ejemplo 2
INSERT INTO propiedades (usuario_id, titulo, descripcion, tipo_operacion, tipo_inmueble, moneda, precio, calle, altura, piso, departamento, barrio, ciudad, ambientes, dormitorios, banos, superficie_total, estado)
VALUES (1, 'Departamento 2 Ambientes Luminoso', 'Ideal primera vivienda o inversión. Bajas expensas.', 'alquiler', 'departamento', 'ARS', 450000.00, 'Av. Cabildo', '2400', '5', 'C', 'Belgrano', 'CABA', 2, 1, 1, 45.00, 'disponible');

-- Imágenes de Ejemplo
INSERT INTO imagenes_propiedad (propiedad_id, url_imagen, es_principal) VALUES (1, 'assets/img/casa_palermo_1.jpg', TRUE);
INSERT INTO imagenes_propiedad (propiedad_id, url_imagen, es_principal) VALUES (2, 'assets/img/depto_belgrano_1.jpg', TRUE);
